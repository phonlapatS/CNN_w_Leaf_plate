...
class LeafPlateDetectionApp:
    ...
    def setup_app(self):
        ...
        self.app.configure(fg_color="#f0f0f0")
    ...
    def create_shape_counts_card(self, parent):
        ...
        # Heart count
        heart_frame = ctk.CTkFrame(shape_card, width=180, height=80, fg_color="#fff5f5", corner_radius=8)
        ...
        ctk.CTkLabel(heart_frame, text=str(self.shape_counts["heart"]), font=("Arial", 18, "bold"),
                     text_color="#2c3e50").place(x=90, y=55, anchor="center")

        # Rectangle count
        rect_frame = ctk.CTkFrame(shape_card, width=180, height=80, fg_color="#f0f8ff", corner_radius=8)
        ...
        # Oval count
        oval_frame = ctk.CTkFrame(shape_card, width=180, height=80, fg_color="#f0fff0", corner_radius=8)
        oval_frame.place(x=400, y=45)

        ctk.CTkLabel(oval_frame, text="Oval", font=("Arial", 12, "bold"), text_color="#27ae60").place(x=90, y=25,
                                                                                                      anchor="center")
    ...
    def create_defect_table(self, parent):
        ...
        ctk.CTkLabel(
            ...
            font=("Arial", 14, "bold"),
            text_color="white"
        ).place(x=200, y=20, anchor="center")
        ...
        ctk.CTkLabel(
            ...
            font=("Arial", 14, "bold"),
            text_color="white"
        ).place(x=650, y=20, anchor="center")
        ...
        ctk.CTkLabel(
            ...
            font=("Arial", 14, "bold"),
            text_color="white"
        ).place(x=1100, y=20, anchor="center")
        ...
        for i, (defect, status, color) in enumerate(self.defect_data):
            ...
            row_color = "#ffffff" if i % 2 == 0 else "#f1f2f6"
            ...
            ctk.CTkLabel(
                ...
                font=("Arial", 12),
                text_color="#2c3e50"
            ).place(x=200, y=12, anchor="center")

            # Status with color coding
            status_color = "#27ae60" if color == "green" else "#e74c3c"
            ...
            ).place(x=650, y=12, anchor="center")

            # Action button
            action_text = "Reset" if color == "red" else "Monitor"
            action_color = "#e74c3c" if color == "red" else "#3498db"
            ...
            ctk.CTkButton(
                ...
                command=lambda idx=i: self.defect_action(idx)
            ).place(x=1100, y=12, anchor="center")
